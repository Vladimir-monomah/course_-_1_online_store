...
if ($_SESSION['auth_admin'] == "yes_auth")
{
  ...
  $_SESSION['urlpage'] = "<a href='index.php' >Главная</a> \ <a href='administrators.php' >Администраторы/менеджеры</a>";
...
<p class="links-actions" align="right" ><a class="green" href="edit_administrators.php?id='.$row["id"].'" >Редактировать</a> | <a class="delete" rel="administrators.php?id='.$row["id"].'&action=delete" >Убрать</a></p>
</li>
</ul>   
    ';
