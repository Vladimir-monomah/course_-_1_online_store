...
<ul>
<li><a href="tovar.php?cat=pc"><strong>Компьютеры</strong></a></li>
<?php
 $result1 = mysql_query("SELECT * FROM category WHERE type='pc'",$link);
  If (mysql_num_rows($result1) > 0)
{
$row1 = mysql_fetch_array($result1);
do
...
<a class="green" href="edit_product.php?id='.$row["products_id"].'">Редактировать</a> | <a rel="tovar.php?'.$url.'id='.$row["products_id"].'&action=delete" class="delete" >Убрать</a>
</p>
 </li> 
 ';   
