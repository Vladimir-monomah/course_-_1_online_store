...
<!--Список с навигацией. -->
<ul id="header-top-menu" type="none">
<li><li><div id="tow"><?php echo localize_text('Ваш город...', $_SESSION["lang"], $link); ?></div></li></li>
<li><a href="o_nas.php"><?php echo localize_text('О нас', $_SESSION["lang"], $link); ?></a></li>
<li><a href="feedback.php"><?php echo localize_text('Обратная связь', $_SESSION["lang"], $link); ?></a></li>
</ul>
<!--Вход и регистрация. -->
<?php
...
<!--Информационный блок. -->
<div id="pesonal-info">
<p align="right"><?php echo localize_text('Звонок бесплатный', $_SESSION["lang"], $link); ?></p>
<h3 align="right">8 (800) 333-12-43</h3>
<img src="/images/phone-icon.png"/>
<p align="right"><?php echo localize_text('Режим работы интернет-магазина', $_SESSION["lang"], $link); ?></p>
<p align="right"><?php echo localize_text('Круглосуточно', $_SESSION["lang"], $link); ?></p>
...
<div id="top-menu">
<ul type="none">
<li><img src="/images/shop.png"/><a href="index.php"><?php echo localize_text('Главная', $_SESSION["lang"], $link); ?></a></li>
<li><img src="/images/new-32.png"/><a href="view_aystopper.php?go=news"><?php echo localize_text('Новинки', $_SESSION["lang"], $link); ?></a></li>
<li><img src="/images/bestprice-32.png"/><a href="view_aystopper.php?go=leaders"><?php echo localize_text('Лидеры продаж', $_SESSION["lang"], $link); ?></a></li>
<li><img src="/images/sale-32.png"/><a href="view_aystopper.php?go=sale"><?php echo localize_text('Распродажа', $_SESSION["lang"], $link); ?></a></li>
</ul>
