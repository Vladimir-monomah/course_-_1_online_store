...
<p><?php echo localize_text('Выбирайте удобный для вас способ заказа!', $_SESSION["lang"], $link); ?></p>
                        <ol class="ui-list-num">
                            ...
                            <li><b><p align="justify"><?php echo localize_text('Оформление заказа по телефону.</b> Хотите получить консультацию по телефону? Позвоните по<br> бесплатному телефону 8 (800) 333-12-43, и оператор интернет-магазина поможет сделать выбор и оформить заказ.', $_SESSION["lang"], $link); ?></li>
                        </ol>
